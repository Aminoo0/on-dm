    ...
    return (
        <section className='flex flex-wrap p-5 pb-20 pt-10 2xl:px-52'>
            <div className='w-full lg:w-1/2'>
                <h2 className='text-transparent bg-gradient-to-r from-[#29281e] to-violet-500 bg-clip-text font-semibold pb-3'>نهج إبداعي يجسد نجاحك على أرض الواقع بداية من تحويل فكرتك لموقع إلكتروني إلى تسويق فكرتك وتحويلها لأرباح.</h2>
